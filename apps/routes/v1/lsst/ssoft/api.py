...
ARGS = ns.model(
    "ssoft",
    {
        ...
        "flavor": fields.String(
            description="Data model among HG (default), HG1G2. Note that phase coverage is not great for LSST, hence HG1G2 is not expected to work.",
            example="SHG1G2",
            required=False,
        ),
        "version": fields.String(
            description="Version of the SSOFT YYYY.MM. By default it uses the latest one. Starts at 2026.08",
            example="2026.08",
            required=False,
        ),
